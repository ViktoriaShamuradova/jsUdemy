...
public class ArraySum {
    public static void main(String[] args) {
        ...
        System.out.println("Array second " + Arrays.toString(second));
        System.out.println("Array sum " + Arrays.toString(sum(first, second)));
        System.out.println("Array sum " + Arrays.toString(sum(first, new int[1])));
    }
